...
void readData(customer *data) {
    ...
    scanf("%d", &data->departureTime.hour);
    printf("Departure time minutes: ");
    scanf("%d", &data->departureTime.minutes);
    printf("Departure date day: ");
    scanf("%d", &data->departureDate.day);
    printf("Departure date month: ");
    scanf("%d", &data->departureDate.month);
    printf("Departure date year: ");
    scanf("%d", &data->departureDate.year);
}

void displayData(customer *data, int n) {
...
void bubbleSortSurname(customer *data, int n) {
    int swapped;
    customer temp;
...
void radixSortDepartureDate(customer *data, int n) {
...
void modifyCustomerData(customer *data, int n) {
    char searchName[30];
    ...
    switch (choice) {
        ...
        case 4:
            ...
            scanf("%d", &data[foundIndex].departureTime.hour);
            printf("Enter new departure time minutes: ");
            scanf("%d", &data[foundIndex].departureTime.minutes);
            break;
        case 5:
            printf("Enter new departure date day: ");
            scanf("%d", &data[foundIndex].departureDate.day);
            printf("Enter new departure date month: ");
            scanf("%d", &data[foundIndex].departureDate.month);
            printf("Enter new departure date year: ");
            scanf("%d", &data[foundIndex].departureDate.year);
            break;
        default:
...
void version1() {
    ...
    customer *registerData = malloc(n * sizeof(customer));
    for (int i = 0; i < n; i++) {
        printf("\nCustomer %d:\n\n", i + 1);
    ...
    free(registerData); // Free allocated memory for the array of customers
    return 0;
}
